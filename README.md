...
# input needed - playstyle type (difficulty, type of specialty, etc.)
# intermediate - difficulty level, ability score rankings, spellcasting (yes/no) and flavoring of spellcasting, fighting ability (heavy martial focus or not), stealth ability (stealthy playstyle),  
# output needed - recommended class subclass race combo, give top 3 combos, later implement ability scores 

# number of potential combos 